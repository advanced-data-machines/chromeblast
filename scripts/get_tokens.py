...
USERNAME = 'username'
PASSWORD = 'password'
USERNAME2 = 'serviceaccount_user'

# Optional Overrides (Set to None to ignore)
#device_id = '78:31:c1:b9:95:04'
device_id = None
master_token = None
access_token = None
...
if len(sys.argv) - 1 < 2:
    print("Usage:  get-tokens.sh <username> <password>")
    exit()
...
if not access_token:
    access_token = get_access_token(USERNAME2, master_token, device_id)
